...
internal struct Rygel.ODID.FolderDefinition {
    string title;
    string definition;
}
...
const Rygel.ODID.FolderDefinition[] VIRTUAL_FOLDERS_DEFAULT = {
    { N_("Year"), "dc:date,?" },
    { N_("All"),  "" }
};
...
// for use with QueryContainer.
const Rygel.ODID.FolderDefinition[] VIRTUAL_FOLDERS_MUSIC = {
 ...
 */
public class Rygel.ODID.RootContainer : TrackableDbContainer {
